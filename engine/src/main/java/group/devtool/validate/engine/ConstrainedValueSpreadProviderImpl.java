...
public class ConstrainedValueSpreadProviderImpl implements ConstrainedValueSpreadProvider {
  ...
  static {
    ...
    BUILTIN.add(new ConstrainedSetSpreader());
  ...
  public static class ConstrainedSetSpreader implements ConstrainedValueSpreader {

    public ConstrainedSetSpreader() {
